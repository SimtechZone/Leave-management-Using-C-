...
void loading()
{
    ...
    {
    	gotoxy(50,15);
		cout<<"Laoding \\";system("cls");usleep(10000);
	    gotoxy(50,15);
		cout<<"Laoding |";system("cls");usleep(10000);
	    gotoxy(50,15);
		cout<<"Laoding /";system("cls");usleep(10000);
...
int main()
{
	...
	int ch;
	cout<<s3<<"--------------------------------------------------------------------------"<<nl;
	cout<<s3<<"-------------- L E A V E   M A N A G E M E N T  S Y S T E M --------------"<<nl;
	cout<<s3<<"--------------------------------------------------------------------------"<<nl<<nl;
	//cout<<s6<<"   ********************"<<nl;
	cout<<s6<<" *** M A I N  M E N U ***"<<nl<<nl;
	cout<<s6<<" ________________________"<<nl;
	cout<<s6<<"|                        |"<<nl;
    cout<<s6<<"| 0. Dev Details         |"<<nl;
	cout<<s6<<"| 1. APPLY LEAVE         |"<<nl;
	cout<<s6<<"| 2. DELETE LEAVE        |"<<nl;
	cout<<s6<<"| 3. SEARCH LEAVE        |"<<nl;
	cout<<s6<<"| 4. MODIFY LEAVE        |"<<nl;
	cout<<s6<<"| 5. DISPLAY ALL LEAVES  |"<<nl;
	cout<<s6<<"| 6. USER MANAGEMENT     |"<<nl;
	cout<<s6<<"| 7. EXIT                |"<<nl;
	cout<<s6<<"|________________________|"<<nl;
	cout<<nl<<s4<<cyp;
	cin>>ch;
